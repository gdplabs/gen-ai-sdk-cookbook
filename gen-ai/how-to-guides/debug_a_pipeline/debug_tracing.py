"""Debug tracing with enable_debug_tracing() and disable_debug_tracing().

See https://gdplabs.gitbook.io/sdk/gen-ai-sdk/guides/debug-a-pipeline#debug-tracing
"""
...
async def main() -> None:
    ...
    result = await pipeline.invoke(
        {"text": "silent run", "text_upper": "", "text_len": 0}
    )
    print(result)
