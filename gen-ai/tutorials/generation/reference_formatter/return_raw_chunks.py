"""Reference Formatter: Returning Raw Chunks.

Demonstrates using stringify=False to return raw relevant chunks instead of
formatted text.

Reference: https://gdplabs.gitbook.io/sdk/gen-ai-sdk/tutorials/generation/reference-formatter#returning-raw-chunks
"""
...
async def main() -> None:
    ...
    try:
        ref_formatter = SimilarityBasedReferenceFormatter(
            em_invoker, threshold=0.7, stringify=False
        )
