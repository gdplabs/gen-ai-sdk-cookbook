...
This example specifically requires you to complete all setup steps listed on the [Prerequisites](/sdk/gen-ai-sdk/prerequisites.md) and [Index Your Data with Vector Data Store](/sdk/gen-ai-sdk/guides/index-your-data-with-vector-data-store.md) page.

You should be familiar with these concepts and components:

1. [Introduction to RAG](/sdk/gen-ai-sdk/guides/introduction-to-rag.md)
2. [Data Store](/sdk/gen-ai-sdk/tutorials/data-store.md)
3. [Language Model (LM) Invoker](/sdk/gen-ai-sdk/tutorials/inference/lm-invoker.md)
4. [Embedding Model (EM) Invoker](/sdk/gen-ai-sdk/tutorials/inference/em-invoker.md)
5. [Retriever](/sdk/gen-ai-sdk/tutorials/retrieval/retriever.md)
6. [Repacker](/sdk/gen-ai-sdk/tutorials/generation/repacker.md)
7. [Response Synthesizer](/sdk/gen-ai-sdk/tutorials/generation/response-synthesizer.md)
8. [Orchestration](/sdk/gen-ai-sdk/tutorials/orchestration.md)
...
{% file src="/files/s0LkasnWXtJ6Eqq9VA5V" %}
{% endstep %}

{% step %}
**Arrange the files**

Arrange them in your project. You can follow the structure in [#project-setup](#project-setup "mention") section.
{% endstep %}
{% endstepper %}

You may use another knowledge base file and adjust accordingly. For more information about how to index data to data store, you can visit this page [Index Your Data with Vector Data Store](/sdk/gen-ai-sdk/guides/index-your-data-with-vector-data-store.md).

## 2) Build Core Components of Your Pipeline

### Create the Retriever

The [Retriever](/sdk/gen-ai-sdk/tutorials/retrieval/retriever.md) finds and pulls useful information from your ChromaDB database. Create `modules/retriever.py`:
...
We'll build the full process in your `pipeline.py` file using GL SDK's [pipeline](https://gdplabs.gitbook.io/sdk/tutorials/orchestration). Open the file and follow these instructions to create [steps](/sdk/gen-ai-sdk/tutorials/orchestration/steps.md) and compose them:

{% hint style="info" %}
Note that in this guide, the states used as input state and output state are only `user_query`, `chunks`, `context`, `state_variables`, and `response`. The full state structure is defined in [State](/sdk/gen-ai-sdk/tutorials/orchestration/state.md#default-state-ragstate).\
\
For each step, you can pass state variables as parameters to their corresponding components. For example, [Vector Retriever](/sdk/gen-ai-sdk/tutorials/retrieval/retriever/vector-retriever.md) accepts `query` as parameter, thus you can pass the `"query"` state and takes value from another state (i.e. `"user_query"`) to be mapped.
{% endhint %}
...
This [component step](/sdk/gen-ai-sdk/tutorials/orchestration/steps.md#step) searches for relevant chunks based on the user's query.
...
Finally, use the [pipe operator](/sdk/gen-ai-sdk/tutorials/orchestration/pipeline.md#the-pipe-operator) (`|`) to chain all steps in order:
...
```
GET https://gdplabs.gitbook.io/sdk/gen-ai-sdk/guides/build-end-to-end-rag-pipeline/your-first-rag-pipeline.md?ask=<question>
```
